...
namespace MediChain.Migrations
{
    ...
    [Migration("20241017064522_updateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediChain.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediChain.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediChain.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediChain.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("MediChain.Models.OrderDetail", b =>
                {
                    b.HasOne("MediChain.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MediChain.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MediChain.Models.OrderHeader", b =>
                {
                    b.HasOne("MediChain.Models.AppUser", "AppUser")
                        .WithMany()
